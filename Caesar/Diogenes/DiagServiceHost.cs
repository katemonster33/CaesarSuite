...
namespace Diogenes
{
    public class DiagServiceHost : CaesarInterpreter.Host.IDiagService
    {
        public CaesarInterpreter.Host.IDiagServiceRunner CreateFromName(string name) 
        {
            ...
            if (ds is null && DiogenesSharedContext.Singleton.PrimaryEcu.GlobalDiagServices != null) 
            {
                ...
                ds = DiogenesSharedContext.Singleton.PrimaryEcu.GlobalDiagServices.GetObjects().FirstOrDefault(x => x.Qualifier == name);
            }
